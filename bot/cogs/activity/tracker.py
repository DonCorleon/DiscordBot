...
class ActivityConfig(ConfigBase):
    ...
    activity_base_message_points_min: float = config_field(
        ...
        category="Gamification/Points System",
        guild_override=True,
        min_value=0.0,
        max_value=10.0
    )
    ...
    leaderboard_default_limit: int = config_field(
        ...
        category="Statistics/Display Options",
        guild_override=True,
        min_value=1,
        max_value=50
    )
    ...
    activity_tier_diamond: int = config_field(
        ...
        category="Gamification/Message Tiers",
        guild_override=True,
        min_value=1,
        max_value=100000
    )
    ...
    voice_tier_lurker: int = config_field(
        ...
        category="Gamification/Voice Tiers",
        guild_override=True,
        min_value=0,
        max_value=10000
    )
    ...
    mystats_milestone_1: int = config_field(
        ...
        category="Gamification/Milestones",
        guild_override=True,
        min_value=1,
        max_value=100000
    )
